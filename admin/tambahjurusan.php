...
if (isset($_POST['simpan'])) {
    // Validasi input
    $namajurusan = isset($_POST['namajurusan']) ? $_POST['namajurusan'] : null;

    if (empty($namajurusan)) { // Perbaikan kondisi
        $error = "Semua kolom harus diisi!";
    }else{
        $db->tambahjurusan( // Gunakan salah satu fungsi
            $namajurusan
        );
                  ...
                  <form action="" method="post">
                    ...
                    <div class="card-body">
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="namajurusan" id="namajurusan" />
                        </div>
                      </div>
                      <div class="row mb-3">
                    ...
                    <a href="datajurusan.php" class="btn float-end">Batal</a>
                    </div>
                    <!--end::Footer-->
                  </form>
                  <!--end::Form-->
