          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                                            ...
                                            <form action="" method="POST">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="namajurusan<?= $x['kodejurusan']; ?>" 
                                                              name="namajurusan" value="<?= htmlspecialchars($x['namajurusan']); ?>" required>
                                                    </div>
                                                </div>
                ...
                <!-- /.card -->
                <a href="tambahjurusan.php">Tambah Data</a> </div>
              </div>
              <!-- /.col -->
            </div>
            <!--end::Row-->
