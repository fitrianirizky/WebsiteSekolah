...
if (isset($_GET['nisn'])) {
    ...
    if(!$result){
        die("Query gagal: " . mysqli_error($db->koneksi));
    }
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Update Siswa</h3></div>
              <div class="col-sm-6">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="card card-warning card-outline mb-4">
                  <!--begin::Header-->
                  <div class="card-header"><div class="card-title">Update Siswa</div></div>
                  <!--end::Header-->
                  <!--begin::Form-->
                  <form action="" method="post">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row mb-3">
                        <label for="kodejurusan" class="col-sm-2 col-form-label">Kode Jurusan</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="kodejurusan" value="<?php echo $data["kodejurusan"]?>" />
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label for="kelas" class="col-sm-2 col-form-label">Kelas</label>
                        <div class="col-sm-10">
                            <select class="form-select" id="kelas" name="kelas" value="<?php echo $data["kelas"]?>" required>
                    ...
                    <button type="submit" class="btn btn-warning" name="simpan">Submit</button>
                    <a href="datasiswa.php" class="btn float-end">Cancel</a>
                    </div>
                    <!--end::Footer-->
                  </form>
                  <!--end::Form-->
