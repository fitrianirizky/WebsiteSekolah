...
$statKelas = $db->getStatistikKelas();
$statGender = $db->getStatistikGender();
?>
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  src="../dist/assets/img/teacher.png"
                  ...
                  <div class="col-md-6">
                      <div class="card">
                          <div class="card-header bg-success text-white">
                              <h3 class="card-title"><i class="fas fa-users me-2"></i>Jumlah Siswa per Kelas</h3>
                          </div>
                          <div class="card-body">
                              <div id="chart-kelas" style="min-height: 300px;"></div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="card">
                          <div class="card-header bg-info text-white">
                              <h3 class="card-title"><i class="fas fa-venus-mars me-2"></i>Distribusi Jenis Kelamin</h3>
                          </div>
                          <div class="card-body">
...
const statKelas = <?php echo json_encode($statKelas); ?>;
const statGender = <?php echo json_encode($statGender); ?>;

//Chart Kelas
const kelasChart = new ApexCharts(document.querySelector("#chart-kelas"), {
    series: [{
        name: 'Jumlah Siswa',
        data: statKelas.map(item => item.jumlah)
    }],
    chart: {
        type: 'bar',
        height: 350
    ...
    colors: ['#1cc88a'],
    xaxis: {
        categories: statKelas.map(item => 'Kelas ' + item.kelas),
        title: {
            text: 'Kelas'
        }
    },
...
const genderChart = new ApexCharts(document.querySelector("#chart-gender"), {
    series: statGender.map(item => item.jumlah),
    chart: {
        type: 'donut',
        height: 350
    },
    labels: statGender.map(item => item.jeniskelamin === 'L' ? 'Laki-laki' : 'Perempuan'),
